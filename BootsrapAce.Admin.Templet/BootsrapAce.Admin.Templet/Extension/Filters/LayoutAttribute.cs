...
using Spgc.Framework.Common.ToolsHelper;

namespace BootsrapAce.Admin.Templet.Extension.Filters
{
    ...
    public class LayoutAttribute : ActionFilterAttribute
    {
        ...
        private List<Models.SidebarMenuModel> InitSidebarMenu()
        {
